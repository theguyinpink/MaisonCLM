        ...
        <FadeIn>
          <div className="services-header">
            ...
            <h2 className="section-title">
              Des prestations
              <br />
              adaptées à <em>chaque besoin</em>
            </h2>
            <p className="section-desc">
              De la simple page vitrine au projet complexe sur mesure — des solutions
              pensées pour votre niveau de besoin et votre budget.
            </p>
          </div>
        </FadeIn>
